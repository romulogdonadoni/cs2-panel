...
/**
 * Inicia o fluxo OpenID 2.0 (Steam) — redireciona o browser.
 */
...
/**
 * Após o Steam redirecionar de volta, valida a resposta e devolve o SteamID64, ou null.
 */
export async function verifySteamOpenIdCallback(query: URLSearchParams): Promise<string | null> {
  if (query.get("openid.mode") === "setup_needed") {
    return null;
  }
