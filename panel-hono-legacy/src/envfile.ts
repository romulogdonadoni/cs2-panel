...
/**
 * Lê ficheiro .env do diretório do compose (caminho absoluto projectDir).
 */
...
/**
 * Garante as chaves mínimas; escreve .env (UTF-8) na raiz do project.
 */
export function writeServerEnvFile(
  projectDir: string,
