...
const nextConfig: NextConfig = {
  images: {
    remotePatterns: [
      ...
      { protocol: "https", hostname: "community.fastly.steamstatic.com", pathname: "/**" },
      { protocol: "https", hostname: "cdn.steamstatic.com", pathname: "/**" },
      { protocol: "https", hostname: "media.steamstatic.com", pathname: "/**" },
      { protocol: "https", hostname: "shared.akama.steamstatic.com", pathname: "/**" },
